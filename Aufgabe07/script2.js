...
(function (Pflanzen) {
    ...
    function generateArticles(_pflanzenprodukte) {
        ...
        for (let _index = 0; _index < _pflanzenprodukte.length; _index++) {
            ...
            //"Button" in Warenkorb
            _newButton.setAttribute("name", _pflanzenprodukte[_index].name);
            _newButton.setAttribute("img", _pflanzenprodukte[_index].bild);
            _newButton.setAttribute("beschreibung", _pflanzenprodukte[_index].beschreibung);
            _newButton.setAttribute("kategorie", _pflanzenprodukte[_index].kategorie);
